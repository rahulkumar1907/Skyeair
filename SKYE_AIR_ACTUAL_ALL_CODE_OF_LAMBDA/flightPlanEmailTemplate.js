...
exports.handler = async (event) => {
  ...
  //     var   TemplateData = "{ \"FlightId\":\""+FlightId+"\", \"OrderId\":\""+OrderId+"\",\"SkyTunnelId\":\""+SkyTunnelId+"\", \"StartTime\":\""+StartTime+"\",\"PackageType\":\""+PackageType+"\",\"PackageWeight\":\""+PackageWeight+"\",\"PackageCategory\":\""+PackageCategory+"\",\"VolumetricWeight\":\""+VolumetricWeight+"\",\"PickupTime\":\""+PickupTime+"\",\"ColdChain\":\""+ColdChain+"\",\"DroneId\":\""+DroneId+"\",\"DroneName\":\""+DroneName+"\",\"ClientId\":\""+ClientId+"\",\"OrganizationId\":\""+OrganizationId+"\",\"ApproveLink\":\""+ApproveLink+"\" ,\"EndTime\":\""+EndTime+"\" }";
  //       var params = {
